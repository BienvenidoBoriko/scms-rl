        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <div class="navbar-brand">
                <a href="{{ url('/') }}" class="logo">
                    <!-- Logo icon -->
                    <b class="logo-icon">
                        <img src="{{ asset('logo.png') }}" style="max-width: 30px" alt="logo-scmsrl"
                            class="light-logo w-25" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
            ...
            <ul class="navbar-nav justify-content-end w-100">
                ...
                @else
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted pro-pic" href=""
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{ asset(Auth::user()->profile_img) }}" alt="user" class="rounded-circle"
                                width="31"></a>
