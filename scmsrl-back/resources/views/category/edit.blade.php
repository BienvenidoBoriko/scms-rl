...
<section class="container-fluid">
    <div class="card pl-3 pr-3">
        <form class="mt-4 mb-2" id="category-create-form"
            ...
            <div class="form-group">
                <div class="form-row">
                    ...
                    <div class="col"><label for="slug">slug<br></label><input value="{{ $category->slug }}" id="slug"
                            name="slug" class="form-control @error('slug') is-invalid @enderror" type="text">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-8 pl-0">
                                    <input id="thumbnail"
                                        ...
                                        value="{{ $category->featured_img }}" name="featured_img">
            ...
            <div class="form-group">
                <div class="form-check"><input class="form-check-input @error('visibility') is-invalid @enderror"
                        {{ $category->visibility=='true'?'checked="checked"':'' }}
                        name="visibility" value="true" type="radio" id="visibility"><label class="form-check-label"
