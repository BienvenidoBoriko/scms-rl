...
<section>
    ...
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="form-group">
            <div class="form-row">
                <div class="col"><label for="titulo">nombre<br></label><input name="name" class="form-control @error('name') is-invalid @enderror" type="text"
                value="{{old('name')}}" id="name" required="required">
            <x-error-message name="name"/>
            </div>
                <div class="col"><label for="slug">slug<br></label><input id="slug" value="{{old('slug')}}" name="slug" class="form-control @error('slug') is-invalid @enderror" type="text">
    ...
    <x-error-message name="description"/>
        ...
        <div class="form-group">
            <div class="form-check"><input class="form-check-input @error('visibility') is-invalid @enderror" name="visibility" value="si" type="radio" id="visibility"><label
