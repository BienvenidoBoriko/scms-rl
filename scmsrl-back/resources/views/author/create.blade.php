                    ...
                    <fieldset class="p-2">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-8 pl-0">
                                <input id="thumbnail" class="form-control @error('profile_img') is-invalid @enderror" type="text" value="{{ old('profile_img') }}" name="profile_img">
                ...
                <div class="col">
                    <fieldset class="p-2">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-8 pl-0">
                                <input id="thumbnail2" class="form-control @error('cover_img') is-invalid @enderror" type="text" value="{{ old('cover_img') }}" name="cover_img">
